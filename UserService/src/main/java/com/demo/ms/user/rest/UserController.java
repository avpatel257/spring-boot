package com.demo.ms.user.rest;

import com.demo.ms.user.domain.Customer;
import com.demo.ms.user.domain.User;
import com.demo.ms.user.service.UserService;
...
public class UserController {
    ...
    public User getCliente(@PathVariable String id) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Not Found"),
            @ApiResponse(code = 500, message = "Failure")})
    public ResponseEntity<User> udpate(@PathVariable("id") String id, @RequestBody User user) {
